...
from genesis.variant import viewsWS as views_ws
...
urlpatterns = [
    ...
    path('filters/<str:sample_name>/',
         views_ws.VariantView.find_distinct_filters,
    ...
    path('node_value/<str:sample_name>/<str:node>/<str:value>/',
         views_ws.VariantView.find_node_value,
    ...
    path('frequency/<str:sample_name>/<int:frequency>/<str:comparator>/',
         views_ws.VariantView.find_frequency,
