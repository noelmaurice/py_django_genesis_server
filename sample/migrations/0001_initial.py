    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('filters', django.contrib.postgres.fields.ArrayField(
                    base_field=models.CharField(help_text='Filters', max_length=200), size=None)),
            ],
            options={
                'db_table': 'sample',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sample', models.ForeignKey(help_text='Sample', on_delete=django.db.models.deletion.CASCADE,
                                             to='sample.sample')),
            ],
            options={
                'db_table': 'part',
